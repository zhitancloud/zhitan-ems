<div align="center">
    <img src="readme/logo-chinese.png" alt="智碳能碳管理平台" height="150" width="150">
</div>
...
17. 建筑能耗分析（支路、分项） **已完成**
18. 智慧储能（监测、配置、分析） **已完成**  
    18.1. 储能监测 **2025年8月已完成**  
    18.2. 储能配置 **2025年8月已完成**  
    18.3. 储能及时统计 **2025年8月已完成**
19. 能源成本分析 **已完成**
20. 能源深度分析（能流图） **已完成**
21. 基于吨标煤的碳排放分析 **已完成**
22. 单耗分析  **2025年10月已完成**
...
![输入图片说明](readme/img/2-2-首页-深色.png)
     ...
     首页-成本看板 
![输入图片说明](readme/img/2-3-首页-成本看板.png)

    首页-储能看板
![输入图片说明](readme/img/2-4-首页-储能看板.png)

    首页-告警看板
![输入图片说明](readme/img/2-5-首页-告警看板.png)
